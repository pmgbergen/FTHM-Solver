...
class Geometry(pp.SolutionStrategy):
    def initial_condition(self) -> None:
        ...
        # vals = np.load(f"{self.simulation_name()}_steady_high_perm_small_frac.npy")
        vals = np.load(f"stats_thermal_geo4x2_sol3_bb2_fr1_endstate_1737562270164.npy")
